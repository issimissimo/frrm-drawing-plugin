...
Online: <https://issimissimo.com/temp/frmm-drawing-plugin-10/> (con `?tutorial` il tutorial parte comunque). Codice su <https://github.com/issimissimo/frrm-drawing-plugin>, **44 test** (`node test/run.js`).
...
**Il test con un bambino** — scelto il 18/09/2026. È la DoD della Fase 4 nel brief, non è mai stata soddisfatta, costa un pomeriggio e zero righe di codice. Si fa su <https://issimissimo.com/temp/frmm-drawing-plugin-10/>, da un telefono, con qualcuno fra i 5 e i 12 anni che non ha mai visto l'app.
